<template>
  <q-layout view="lHh Lpr lFf">
    ...
    <q-header class="bg-blue-grey-2 text-blue-grey-6">
      <q-toolbar>
          ...
          <q-menu>
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <q-linear-progress class="q-mb-lg" :value="100" color="teal-4" style="height: 2px"/>
              ...
              <div class="column items-center">
                <q-btn flat round dense>
                  <q-avatar size="72px">
                    <q-img spinner-color="white" placeholder-src="statics/FOTO.jpg" src="statics/FOTO.jpg">
                    </q-img>
                  </q-avatar>
                </q-btn>
    ...
    <q-drawer
      ...
      :breakpoint="500"
      show-if-above
      content-class="bg-blue-grey-2 text-teal-10"
    >
      <q-scroll-area class="fit">
        <q-list>
          <q-item style="height: 50px;" class="bg-blue-grey-2 text-bold">
            <q-item-section>
              Aplikasi Penjualan Beras Toko Beras Ataya
            </q-item-section>
          </q-item>
